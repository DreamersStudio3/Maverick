...
- **Maverick 전투 MDA와 목표 전투 계약** (14 connections) — `docs/wiki/Combat-Design-MDA.md`
...
- **4. 목표와 미결정의 경계** (1 connections) — `docs/wiki/Combat-Design-MDA.md`
- **5.1 기본공격은 두 질문만 담당한다** (1 connections) — `docs/wiki/Combat-Design-MDA.md`
- **5.2 스킬은 3+1 역할 문법을 공유한다** (1 connections) — `docs/wiki/Combat-Design-MDA.md`
- **5.3 자원은 주 gate 하나를 가진다** (1 connections) — `docs/wiki/Combat-Design-MDA.md`
