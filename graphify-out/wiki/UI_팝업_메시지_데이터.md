...
- **FMVPopupMessageData** (8 connections) — `Source/Maverick/UI/System/MVUIDataTypes.h`
- **MVUIDataTypes.h** (7 connections) — `Source/Maverick/UI/System/MVUIDataTypes.h`
- **FMVMenuEntryData** (6 connections) — `Source/Maverick/UI/System/MVUIDataTypes.h`
- **UMVMessagePopup()** (4 connections) — `Source/Maverick/UI/Popup/MVMessagePopup.h`
- **MVInteractionPromptPopup.h** (3 connections) — `Source/Maverick/UI/Popup/MVInteractionPromptPopup.h`
- **MVMessagePopup.h** (3 connections) — `Source/Maverick/UI/Popup/MVMessagePopup.h`
- **FText** (3 connections)
