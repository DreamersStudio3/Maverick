...
- **FMVExecuteFixedAttackTaskInstanceData** (28 connections) — `Source/Maverick/AI/Task/MVExecuteAttackTask.h`
...
- **StartedActionTableName** (1 connections) — `Source/Maverick/AI/Task/MVExecuteAttackTask.h`
- **ActionComponent** (1 connections) — `Source/Maverick/AI/Task/MVExecuteAttackTask.h`
- *... and 14 more nodes in this community*

## Relationships

- [AI 공격 액션 후보 해석](AI_%EA%B3%B5%EA%B2%A9_%EC%95%A1%EC%85%98_%ED%9B%84%EB%B3%B4_%ED%95%B4%EC%84%9D.md) (4 shared connections)
