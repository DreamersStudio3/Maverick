...
# MVHitReactionBuildAvailableRowNameLog
...
```dataview
TABLE source_file, type FROM #community/MVHitReactionBuildAvailableRowNameLog
SORT file.name ASC
```
...
- [[UMVHitReactionComponentFindHitReactionActionRow()]] - degree 4, connects to 2 communities
...
- [[UMVHitReactionComponentFindBaseActionRow()]] - degree 4, connects to 1 community