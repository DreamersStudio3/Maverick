...
## Members
- [[dot-Reset()_2]] - code - Source/Maverick/AI/MVAICombatTypes.h
...
```dataview
TABLE source_file, type FROM #community/ExecuteAttackResolveActionCandidate
SORT file.name ASC
```
...
- [[FMVActionRequest()]] - degree 6, connects to 2 communities