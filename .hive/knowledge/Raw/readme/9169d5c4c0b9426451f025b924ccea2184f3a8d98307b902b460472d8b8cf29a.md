...
- `document.md` 첫머리에 제목·부제목·최근 수정·관련 문서 frontmatter 유지
...
- 적용 범위: 보관함 루트 `/`와 모든 하위 폴더, `template/` 제외
- 새 빈 Markdown 생성 시 제목·부제목·최근 수정자를 묻고 frontmatter와 H1 자동 생성
- Templater `Trigger Templater on new file creation`: 보안상 장치별 활성화 필요
...
- `.obsidian/`: 개인 화면·플러그인 파일은 Git 제외, Templater 공유 설정만 예외
