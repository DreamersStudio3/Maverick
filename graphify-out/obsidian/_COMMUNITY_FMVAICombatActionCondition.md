...
- [[MaxAbsAngle_2]] - code - Source/Maverick/AI/MVAICombatTypes.h
- [[MaxDistance_2]] - code - Source/Maverick/AI/MVAICombatTypes.h
- [[Metadata]] - code - Source/Maverick/AI/MVAICombatTypes.h
- [[MinDistance_2]] - code - Source/Maverick/AI/MVAICombatTypes.h
- [[TArray_9]] - code
- [[TestCondition_4]] - code - Source/Maverick/AI/Condition/MVCombatDecisionCondition.h
...
```dataview
TABLE source_file, type FROM #community/FMVAICombatActionCondition
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_MVAICombatTypes.h]]
- 3 edges to [[_COMMUNITY_FMVCombatDecisionConditionInstanceData]]
...
## Top bridge nodes
- [[FMVAICombatActionCondition]] - degree 21, connects to 4 communities
...
- [[TestCondition_4]] - degree 6, connects to 1 community
