...
- **MVGlobalSensingTask.cpp** (18 connections) — `Source/Maverick/AI/Task/MVGlobalSensingTask.cpp`
- **UpdateGlobalSensingSnapshot()** (14 connections) — `Source/Maverick/AI/Task/MVGlobalSensingTask.cpp`
...
- **APawn** (2 connections)
- **FMVGlobalSensingTask::FMVGlobalSensingTask()** (1 connections) — `Source/Maverick/AI/Task/MVGlobalSensingTask.cpp`

## Relationships

- [전역 전투 센싱 태스크](%EC%A0%84%EC%97%AD_%EC%A0%84%ED%88%AC_%EC%84%BC%EC%8B%B1_%ED%83%9C%EC%8A%A4%ED%81%AC.md) (8 shared connections)
- [전역 센싱 전투영역 디버그](%EC%A0%84%EC%97%AD_%EC%84%BC%EC%8B%B1_%EC%A0%84%ED%88%AC%EC%98%81%EC%97%AD_%EB%94%94%EB%B2%84%EA%B7%B8.md) (5 shared connections)
- [AI 전역 감지 설정](AI_%EC%A0%84%EC%97%AD_%EA%B0%90%EC%A7%80_%EC%84%A4%EC%A0%95.md) (5 shared connections)
- [AI 전역 쿨다운](AI_%EC%A0%84%EC%97%AD_%EC%BF%A8%EB%8B%A4%EC%9A%B4.md) (1 shared connections)
