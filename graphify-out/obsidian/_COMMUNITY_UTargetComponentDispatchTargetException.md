...
```dataview
TABLE source_file, type FROM #community/UTargetComponentDispatchTargetException
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_ETargetFocusPointType]]
- 2 edges to [[_COMMUNITY_TargetComponent.cpp]]
- 1 edge to [[_COMMUNITY_UTargetComponentGetFocusPointLocation]]
