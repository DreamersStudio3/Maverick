...
- [[FLockOnTargetModule]] - code - Plugins/LockOnTarget/Source/LockOnTarget/LockOnTarget.h
- [[IModuleInterface_2]] - code
- [[LockOnTarget.cpp]] - code - Plugins/LockOnTarget/Source/LockOnTarget/LockOnTarget.cpp
- [[LockOnTarget.h]] - code - Plugins/LockOnTarget/Source/LockOnTarget/LockOnTarget.h
- [[LockOnTargetDefines.h]] - code - Plugins/LockOnTarget/Source/LockOnTarget/Public/LockOnTargetDefines.h
- [[StartupModule_2]] - code - Plugins/LockOnTarget/Source/LockOnTarget/LockOnTarget.h
...
```dataview
TABLE source_file, type FROM #community/LockOnTargetDefinesh
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_LockOnTargetComponent.cpp]]
- 1 edge to [[_COMMUNITY_LockOnTargetExtensionBase.cpp]]
- 1 edge to [[_COMMUNITY_TargetPreviewExtension.cpp]]
- 1 edge to [[_COMMUNITY_WidgetExtension.cpp]]
- 1 edge to [[_COMMUNITY_TargetComponent.cpp]]
