...
- 5 edges to [[_COMMUNITY_플레이어 회복약 액션]]
- 1 edge to [[_COMMUNITY_회복 물약 액션 식별]]
- 1 edge to [[_COMMUNITY_플레이어 회피 입력 계약]]
- 1 edge to [[_COMMUNITY_무기 장착 시각화]]

## Top bridge nodes
- [[ApplyMVPlayerConsumableHealingPotionDataRowDefaults()]] - degree 4, connects to 2 communities
