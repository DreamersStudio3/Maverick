...
# TableAssetGeneratorIsDirectManagedPackagePath()

## Connections
- [[FString_21]] - `references` [EXTRACTED]
- [[MVTableAssetGenerator.cpp]] - `contains` [EXTRACTED]
- [[TableAssetGeneratorIsDirectManagedObjectPath()]] - `calls` [EXTRACTED]
- [[TableAssetGeneratorIsUnderPackageRoot()]] - `calls` [EXTRACTED]
