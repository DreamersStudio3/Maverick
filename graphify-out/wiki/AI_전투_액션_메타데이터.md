...
- **MVAICombatTypes.h** (20 connections) — `Source/Maverick/AI/MVAICombatTypes.h`
- **FMVAICombatResolvedAction** (14 connections) — `Source/Maverick/AI/MVAICombatTypes.h`
- **FMVAICombatActionMetadata** (11 connections) — `Source/Maverick/AI/MVAICombatTypes.h`
- **FORCEINLINE** (5 connections)
- **MVCombatActionEnterCondition.h** (5 connections) — `Source/Maverick/AI/Condition/MVCombatActionEnterCondition.h`
- **MakeCooldownActionId()** (5 connections) — `Source/Maverick/AI/MVAICombatTypes.h`
- **FName** (4 connections)
...
- [AI 공격 액션 후보 해석](AI_%EA%B3%B5%EA%B2%A9_%EC%95%A1%EC%85%98_%ED%9B%84%EB%B3%B4_%ED%95%B4%EC%84%9D.md) (5 shared connections)
- [AI 전투 컨텍스트](AI_%EC%A0%84%ED%88%AC_%EC%BB%A8%ED%85%8D%EC%8A%A4%ED%8A%B8.md) (4 shared connections)
- [AI 공격 실행 데이터](AI_%EA%B3%B5%EA%B2%A9_%EC%8B%A4%ED%96%89_%EB%8D%B0%EC%9D%B4%ED%84%B0.md) (3 shared connections)
- [AI 공격 실행 로직](AI_%EA%B3%B5%EA%B2%A9_%EC%8B%A4%ED%96%89_%EB%A1%9C%EC%A7%81.md) (3 shared connections)
- [AI 전투 진입 조건](AI_%EC%A0%84%ED%88%AC_%EC%A7%84%EC%9E%85_%EC%A1%B0%EA%B1%B4.md) (2 shared connections)
- [전역 전투 센싱 태스크](%EC%A0%84%EC%97%AD_%EC%A0%84%ED%88%AC_%EC%84%BC%EC%8B%B1_%ED%83%9C%EC%8A%A4%ED%81%AC.md) (2 shared connections)
- [AI 전투 의사결정 로직](AI_%EC%A0%84%ED%88%AC_%EC%9D%98%EC%82%AC%EA%B2%B0%EC%A0%95_%EB%A1%9C%EC%A7%81.md) (2 shared connections)
- [AI 전투 결정 설정](AI_%EC%A0%84%ED%88%AC_%EA%B2%B0%EC%A0%95_%EC%84%A4%EC%A0%95.md) (1 shared connections)
- [피격 시스템 공용 타입](%ED%94%BC%EA%B2%A9_%EC%8B%9C%EC%8A%A4%ED%85%9C_%EA%B3%B5%EC%9A%A9_%ED%83%80%EC%9E%85.md) (1 shared connections)
- [AI 공격 기회 판단](AI_%EA%B3%B5%EA%B2%A9_%EA%B8%B0%ED%9A%8C_%ED%8C%90%EB%8B%A8.md) (1 shared connections)
