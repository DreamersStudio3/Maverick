...
```dataview
TABLE source_file, type FROM #community/UTargetComponentGetFocusPointLocation
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_TargetComponent.cpp]]
- 3 edges to [[_COMMUNITY_ETargetFocusPointType]]
