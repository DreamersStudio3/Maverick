...
- **MVGlobalSensingTask.cpp** (17 connections) — `Source/Maverick/AI/Task/MVGlobalSensingTask.cpp`
...
- [FMVGlobalCoolTimeTaskInstanceData](FMVGlobalCoolTimeTaskInstanceData.md) (1 shared connections)
