...
- **FMVCombatDecisionConditionInstanceData** (15 connections) — `Source/Maverick/AI/Condition/MVCombatDecisionCondition.h`
- **FMVCombatDecisionCondition** (4 connections) — `Source/Maverick/AI/Condition/MVCombatDecisionCondition.h`
...
- [AI 전투 의사결정 로직](AI_%EC%A0%84%ED%88%AC_%EC%9D%98%EC%82%AC%EA%B2%B0%EC%A0%95_%EB%A1%9C%EC%A7%81.md) (3 shared connections)
