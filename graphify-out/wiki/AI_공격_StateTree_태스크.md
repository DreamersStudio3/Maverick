...
- **.GetInstanceDataType()** (2 connections) — `Source/Maverick/AI/Task/MVAttackTask.h`
- **FStateTreeTaskCommonBase** (1 connections)
- **UStruct** (1 connections)

## Relationships

- [AI 기본 공격 태스크](AI_%EA%B8%B0%EB%B3%B8_%EA%B3%B5%EA%B2%A9_%ED%83%9C%EC%8A%A4%ED%81%AC.md) (2 shared connections)

## Source Files

- `Source/Maverick/AI/Task/MVAttackTask.cpp`
