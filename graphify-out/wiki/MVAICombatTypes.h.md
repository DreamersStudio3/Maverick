...
- **MVGlobalSensingTask.h** (5 connections) — `Source/Maverick/AI/Task/MVGlobalSensingTask.h`
- **FName** (4 connections)
...
- [FMVAICombatContext](FMVAICombatContext.md) (4 shared connections)
- [ExecuteAttackResolveActionCandidate](ExecuteAttackResolveActionCandidate.md) (4 shared connections)
- [FMVAICombatActionCondition](FMVAICombatActionCondition.md) (3 shared connections)
